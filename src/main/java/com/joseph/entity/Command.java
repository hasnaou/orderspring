...
public class Command {
    ...
    public Date getDateMise() { return dateMise; }

    public void setDateMise(Date dateMise) { this.dateMise = dateMise; }

    public List<CommandArticle> getCommandArticleList() { return commandArticleList; }

    public void setCommandArticleList(List<CommandArticle> commandArticleList) { this.commandArticleList = commandArticleList; }
